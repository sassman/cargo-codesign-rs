...
- [Creating sign.toml](./getting-started/init.md)
- [Checking Your Setup](./getting-started/status.md)
...
- [Generating Keypairs](./update-signing/keygen.md)
- [Signing Release Archives](./update-signing/signing.md)
- [Integrating with Your Updater](./update-signing/integration.md)

# CI Integration

- [GitHub Actions Walkthrough](./ci/github-actions.md)
- [Workflow Generation](./ci/workflow-generation.md)
- [Secrets Management](./ci/secrets.md)
